...
#define GPIO_QSPI_BK1_IO0     ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_IO0_3)
#define GPIO_QSPI_BK1_IO1     ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_IO1_1)
#define GPIO_QSPI_BK1_IO2     ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_IO2_2)
#define GPIO_QSPI_BK1_IO3     ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_IO3_3)

#define GPIO_QSPI_BK2_IO0     ADJ_SLEW_RATE(GPIO_QUADSPI_BK2_IO0_2)
#define GPIO_QSPI_BK2_IO1     ADJ_SLEW_RATE(GPIO_QUADSPI_BK2_IO1_2)
#define GPIO_QSPI_BK2_IO2     ADJ_SLEW_RATE(GPIO_QUADSPI_BK2_IO2_2)
#define GPIO_QSPI_BK2_IO3     ADJ_SLEW_RATE(GPIO_QUADSPI_BK2_IO3_2)

#define GPIO_QSPI_SCK         ADJ_SLEW_RATE(GPIO_QUADSPI_CLK_1    )
#define GPIO_QSPI_CS          ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_NCS_2)
#else

#define GPIO_QSPI_CS          ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_NCS  )
#define GPIO_QSPI_IO0         ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_IO0_3)
#define GPIO_QSPI_IO1         ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_IO1_2)
#define GPIO_QSPI_IO2         ADJ_SLEW_RATE(GPIO_QUADSPI_BK1_IO2_2)
