...
#define GPIO_SPI1_MISO   (GPIO_SPI1_MISO_1 | GPIO_SPEED_25MHz)
#define GPIO_SPI1_MOSI   (GPIO_SPI1_MOSI_1 | GPIO_SPEED_25MHz)
#define GPIO_SPI1_SCK    (GPIO_SPI1_SCK_2 | GPIO_SPEED_25MHz)
...
#define GPIO_WIRELESS_RST (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_2MHz | \
                         GPIO_OUTPUT_CLEAR | GPIO_PORTA | GPIO_PIN12)

#define GPIO_WIRELESS_VREG (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_2MHz | \
                         GPIO_OUTPUT_SET | GPIO_PORTA | GPIO_PIN8)

/* SPI chip selects */
#define GPIO_WIRELESS_CS_0  (GPIO_OUTPUT|GPIO_PUSHPULL| GPIO_SPEED_2MHz | \
                        GPIO_OUTPUT_SET | GPIO_PULLUP | GPIO_PORTA | GPIO_PIN4)
