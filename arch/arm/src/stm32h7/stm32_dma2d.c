...
/* References:
 *   STM32H747 Technical Reference Manual
 */
...
#endif
static uint32_t
stm32_dma2d_memaddress(struct stm32_dma2d_overlay_s *oinfo,
                       uint32_t xpos, uint32_t ypos);
static uint32_t
stm32_dma2d_lineoffset(struct stm32_dma2d_overlay_s *oinfo,
