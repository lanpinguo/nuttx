...
#ifndef __DRIVERS_INPUT_FT6X06_H
#define __DRIVERS_INPUT_FT6X06_H
...
#define FT6X06_TOUCH_STAT_REG             (0x02) /* Touch data status */
                                                 /* See struct ft6x06_touch_point_s */
#define FT6X06_TH_GROUP_REG               (0x80) /* Threshold for touch detection */
#define FT6X06_TH_DIFF_REG                (0x85) /* Filter function coefficients */
#define FT6X06_CTRL_REG                   (0x86) /* Control register */
#define FT6X06_TIMEENTERMONITOR_REG       (0x87) /* Time switching Active to Monitor */
#define FT6X06_PERIODACTIVE_REG           (0x88) /* Report rate in Active mode */
#define FT6X06_PERIODMONITOR_REG          (0x89) /* Report rate in Monitor mode */
#define FT6X06_RADIAN_VALUE_REG           (0x91) /* Minimum allowing angle */
#define FT6X06_OFFSET_LEFT_RIGHT_REG      (0x92) /* Minimum offset */
#define FT6X06_OFFSET_UP_DOWN_REG         (0x93) /* Maximum offset */
#define FT6X06_DISTANCE_LEFT_RIGHT_REG    (0x94) /* Minimum distance */
#define FT6X06_DISTANCE_UP_DOWN_REG       (0x95) /* Minimum distance */
#define FT6X06_DISTANCE_ZOOM_REG          (0x96) /* Maximum distance */
#define FT6X06_LIB_VER_H_REG              (0xa1) /* MS LIB version */
#define FT6X06_LIB_VER_L_REG              (0xa2) /* LS LIB version */
#define FT6X06_CIPHER_REG                 (0xa3) /* Chip selecting */
#define FT6X06_GMODE_REG                  (0xa4) /* Interrupt mode */
#define FT6X06_PWR_MODE_REG               (0xa5) /* Power mode */
#define FT6X06_FIRMID_REG                 (0xa6) /* Firmware version */
#define FT6X06_CHIP_ID_REG                (0xa8) /* Chip ID */
#define FT6X06_RELEASE_CODE_ID_REG        (0xaf) /* Release code version */
#define FT6X06_STATE_REG                  (0xbc) /* Current operating mode */

#define FT6X06_TOUCH_DATA_STARTREG        (1)    /* Address where data begins */
...
#define FT6X06_GEST_ID_SINGLE_CLICK       (0x20)
#define FT6X06_GEST_ID_DOUBLE_CLICK       (0x22)
#define FT6X06_GEST_ID_ROTATE_CLOCKWISE   (0x28)
#define FT6X06_GEST_ID_ROTATE_C_CLOCKWISE (0x29)
#define FT6X06_GEST_ID_ZOOM_IN            (0x40)
...
enum touch_event_e
{
  FT6X06_DOWN    = 0,  /* The state changed to touched */
  FT6X06_UP      = 1,  /* The state changed to not touched */
  FT6X06_CONTACT = 2,  /* There is a continuous touch being detected */
...
struct ft6x06_touch_data_s
{
  ...
  struct ft6x06_touch_point_s touch[FT6X06_MAX_TOUCHES];
};
...
#endif /* __DRIVERS_INPUT_FT6X06_H */
